...
import { decreaceScore, deleteComment, increaseScore, selectRepliesById } from "./comments-slice";
...
const Comment = ({ id, user, content, createdAt, score, replyingTo, parentId = id }) => {
  ...
  return (
    <>
      {/* <div className="flex md:flex-row flex-col-reverse bg-white p-6 rounded-lg md:gap-x-5 gap-y-3"> */}
        ...
        <div className="md:col-start-auto col-start-1 col-end-3">
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center">
              <img className="block w-8 h-8 mr-3" src={user.image.png} />
...
// const Reply = ({ id, user, content, createdAt, score, replyingTo, parentId }) => {
...
//         </div>
//       </div >
//       {isReplyBoxBisible && <NewReplyBox onClose={toggleReplyBox} id={parentId} replyingTo={user.username} />}
//     </>
//   );
// };
